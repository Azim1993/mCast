...
<template>
    <div class="relative ml-10" v-click-away="onClickAway">
        ...
        <div class="relative">
            ...
            <input v-model="searchValue" @keyup.enter="handleUserSearch" type="text" placeholder="Click Enter" class="w-80 h-10 pl-10 pr-4 rounded-lg border border-gray-300 focus:outline-none focus:border-secondary-light">
            <button v-if="searchValue" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-secondary focus:outline-none">
